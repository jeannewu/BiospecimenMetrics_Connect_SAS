...
knitr::kable(notcol_combo2[,c(14,1:3)],caption='Table 14. Number of Tubes Not Collected at Clinic Collection Visits', row.names=FALSE,align=c("l","c","c","c","c","c","c","c"), booktabs = TRUE)
...
knitr::kable(notcol.reasons.research[,c(3,4:8,1,2)], caption='Table 16. Number of Tube Not Collected by Tube Type, and By Site at Clinic Collections',row.names=FALSE,align=c("l","c","c","c","c","c","c"), booktabs = TRUE) %>% kable_styling(latex_options = "scale_down")
